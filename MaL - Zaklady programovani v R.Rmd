...
```{r}
read.csv("https://raw.githubusercontent.com/schubertjan/cviceni_4/master/data_strednik_carka_desetinne.csv",
         sep = ";", 
         dec = ",")
```


Dalsim dulezitym argumentem, ktery uvedeme je `header`. Ten udava, zda ma R pouzit prvni radek dat jako nazev sloupcu vasi tabulky. Defaultni nastaveni je `header = TRUE`. Pokud vase data neobsahuji nazvy sloupcu pouzijte `header=FALSE`.
```{r}
read.csv("https://raw.githubusercontent.com/schubertjan/cviceni_4/master/data_strednik.csv", 
         sep = ";", header = FALSE)
```
...
```{r}
spotify <- read.csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-01-21/spotify_songs.csv", stringsAsFactors = FALSE)
```
...
![](C:/Users/schubertj/OneDrive - Kantar/Documents/MaL/Cviceni 4/spss import.png)
